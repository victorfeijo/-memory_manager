...
private:
    ...
    // ...
    Process* _process;
    std::queue<Process*> _waitingQueue;
};
...
private: // private methods
    // INSERT YOUR CODE HERE
    void createFixedPartitions(unsigned int number);
    unsigned int calculateDivisor(unsigned int number);
};

namespace functions {
    bool fits(Process *process, Partition *partition);
